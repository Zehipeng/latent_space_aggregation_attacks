...
def main() -> None:
    ...
    if args.phase == "prepare":
        from .formal_prepare import prepare_formal_forgery
        ...
        from .formal_attack import run_formal_forgery_attack
        result = run_formal_forgery_attack(**common, project_root=args.project_root)
    else:
        from ..evaluation.formal import evaluate_formal_forgery
