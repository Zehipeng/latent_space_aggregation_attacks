...
from latent_space_aggregation_attacks.formal.attack import _encode
from latent_space_aggregation_attacks.formal.common import assets_by_name, open_rgb
...
def main() -> None:
    ...
    new_latents = _encode(vae, new_images, batch_size=1)
