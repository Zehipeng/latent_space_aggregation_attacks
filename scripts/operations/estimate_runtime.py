...
REQUIRED_STAGES={"asset_load","reference_generation","reference_encoding","jain_forgery","proposed_forgery","jain_removal","proposed_removal","simple_averaging","distortions","final_detection","wrong_key_detection","final_quality","curve_write","curve_read","curve_detection","curve_plot","curve_cleanup"}
def main() -> None:
